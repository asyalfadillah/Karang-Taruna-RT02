  ...
  return (
    <footer className="bg-[#0F4C81] text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid md:grid-cols-4 gap-10">
        ...
        <div>
          <h4 className="mb-4 text-[#D4AF37]" style={{ fontWeight: 600 }}>{t("footer.quickLinks")}</h4>
        ...
        <div>
          <h4 className="mb-4 text-[#D4AF37]" style={{ fontWeight: 600 }}>{t("footer.social")}</h4>
        ...
        <div>
          <h4 className="mb-4 text-[#D4AF37]" style={{ fontWeight: 600 }}>{t("footer.address")}</h4>
